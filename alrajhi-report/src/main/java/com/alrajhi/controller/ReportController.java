...
public class ReportController {
    ...
    @GetMapping
    public ResponseEntity<GenericResponse<Page<ReportResponse>>> getAllAuthor(
    ...
    public ResponseEntity<GenericResponse<String>> createNewAuthor(
        ...
        authorService.createAuthor(reportRequest);
        return ResponseEntity.created(new URI("/")).body(GenericResponse.success("Author has been created"));
    }
